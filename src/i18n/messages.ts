...
export const ONBOARD_CEX_DESCRIPTION_MESSAGE = /* i18n */ {
  ...
  message: 'Transfer your crypto funds from exchanges like {coinbase} or {binance} to your {solana} wallet directly',
};
...
export const ROUTE_MARKET_COUNT_MESSAGE = /* i18n */ {
  ...
  message: '{routeCount, plural, one {This route uses # market} other {This route uses # markets}}.',
};
